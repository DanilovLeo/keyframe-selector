...
class LiberoFinetuneConfig:
    ...
    # --- Extractor ---
    extractor_name: str = "uniform"               # uniform | velocity_zero | gripper_state | gripper_fallback | awe | random
...
def finetune(cfg: LiberoFinetuneConfig) -> None:
    ...
    extractor, traj_key = build_extractor(
        ...
        gripper_fallback_min_n=cfg.gripper_fallback_min_n,
        awe_eps=cfg.awe_error_threshold,
        random_n=cfg.random_n_keyframes,
